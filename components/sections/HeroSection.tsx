        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div>
            ...
            >
              ...
              <a
                href="#proceso"
                className="inline-flex items-center justify-center text-[var(--text-primary)] underline decoration-dotted underline-offset-4 font-medium px-4 py-4 hover:text-emerald-600 transition-colors duration-200"
              >
